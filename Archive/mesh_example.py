...
from graphing import circle_mesh
...
'''
colors = np.ones((4, 4), dtype=float)
colors[:,3] = 0.3
#print(colors)
...
md3 = gl.MeshData.sphere(rows=10, cols=20,radius=7.0)
...
colors[:,3] = 0.3
#print(colors)
verts5,faces5 = circle_mesh(0,0,5,5.0)
print(verts5)
print(faces5)
## Mesh item will automatically compute face normals.
m3 = gl.GLMeshItem(vertexes=verts5, faces=faces5, faceColors=(1,1,0,1), smooth=False)
m3.setGLOptions('additive')
#m3 = gl.GLMeshItem(vertexes=md3._vertexes,faces=md3._faces,faceColors=colors,smooth=True)#, shader='balloon')
